...
async function loadChapter(chapterIndex) {
    ...
    try {
        ...
        console.log('Loading chapter:', {
            ...
            chapter: chapterPath,
            url: `/manga/${encodeURIComponent(currentManga.folderName)}/chapter/${encodeURIComponent(chapterPath)}`
        });
        
        const response = await fetch(`/manga/${encodeURIComponent(currentManga.folderName)}/chapter/${encodeURIComponent(chapterPath)}`);
